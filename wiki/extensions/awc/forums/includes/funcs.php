...
class awcsforum_funcs{
		...
		public static function showip($id, $link, $wordGuest = 'Guest'){
		global $awcs_forum_config;
			
			if($awcs_forum_config->cf_show_guest_ip == '0' AND $id == '0' AND UserPerm < 2){
				if($wordGuest == '&lt;awcsf_word_guest&gt;') $wordGuest = 'Guest';
				return $wordGuest;
			}
        ...
        */ 
        ...
        global $awc_tables;
            ...
            $awc_tables['awc_f_searchindex'] = $dbr->tableName('awc_f_searchindex'); // 2.6.0
