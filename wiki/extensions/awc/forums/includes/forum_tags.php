...
*/
    ...
    ++$here_count;
       $dbr = &wfGetDB( DB_SLAVE );     
           ...
           # $whatforms =  (isset($argv['id'])) ? $argv['id'] : $awcs_forum_config->cf_forumTag_whatforums ;
                  ...
                  # $limit = GetLimit($TotalPosts);
                   ...
                   # $singleline .= ;
                    ...
                    if($info['date'] == "yes" || $info['users'] == "yes"){
                        ...
                        $link = "<a href='". $awc['link'] ."mem_profile/{$u}/{$uID}'>$u</a>";
                        
                        $u = awcsforum_funcs::showip($uID, $link, wfMsg('awcsf_word_guest'));
