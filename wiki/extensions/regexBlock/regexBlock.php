 ...
 * @file
 * @ingroup Extensions
 * @author Bartek ÅapiÅ„ski <bartek at wikia-inc.com>
 * @author Tomasz Klim
...
$wgRegexBlockDatabase = true;

// New user right
$wgAvailableRights[] = 'regexblock';
$wgGroupPermissions['sysop']['regexblock'] = true;
$wgGroupPermissions['sysadmin']['regexblock'] = true;

// Extension credits that will show up on Special:Version
$wgExtensionCredits['specialpage'][] = array(
	'path' => __FILE__,
	'name' => 'regexBlock',
	'author' => array( 'Bartek ÅapiÅ„ski', 'Tomasz Klim', 'Piotr Molski', 'Adrian Wieczorek', 'Alexandre Emsenhuber', 'Jack Phoenix' ),
