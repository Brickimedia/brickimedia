 ...
 */
$messages['ja'] = array(
	'clicktracking' => '使いやすさに配慮したクリック追跡',
	'clicktracking-desc' => 'クリック追跡: ページの再描画を引き起こさないイベントを追跡する機能',
);
 ...
 */
$messages['jv'] = array(
	'clicktracking-desc' => "Klik placak kanggo nglacak kadadéan sing ora marai ''refresh''",
);
...
$messages['ko'] = array(
	...
	'clicktracking-desc' => '마우스 클릭 이벤트 중에서 웹 페이지 새로 고침과 관계없는 것들을 추적합니다.',
);
...
$messages['sr-el'] = array(
	'clicktracking' => 'Praćenje klikova u Inicijativi za upotrebljivost',
	'clicktracking-desc' => 'Praćenje klikova, namenjeno za praćenje događaja koji ne uzrokuju ponovno učitavanje stranice',
);
