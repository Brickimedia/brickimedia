...
// On login and logout, remove clicktracking-session cookie
$wgHooks['UserLogoutComplete'][] = 'ClickTrackingHooks::onLoginLogout';
$wgHooks['UserLoginComplete'][] = 'ClickTrackingHooks::onLoginLogout';
