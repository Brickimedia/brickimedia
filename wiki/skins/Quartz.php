		...
		<div id="mw-head" class="noprint">
			<div id="p-interwiki">
				...
				<ul class="menu">
					...
					<li>
						<a href="http://lmbw.brickimedia.org">LMB Wiki</a>
						<ul class="submenu">
							<li>
								<a href="http://lmbw.brickimedia.org/wiki/Special:RecentChanges">Recent Changes</a>
							</li>
							<li>
								<a href="http://lmbw.brickimedia.org/wiki/Special:Mytalk">My Talk</a>
							</li>
							<li>
								<a href="http://lmbw.brickimedia.org/wiki/Forum:Index">Forums</a>
							</li>
						</ul>
					</li>
				</ul>
