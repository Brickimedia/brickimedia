...
var newsText = "<span class='small'>What to expect</span><br/><br/>Placeholder<br/><br/>Give some info on whatever<br/><br/><img src='img/back.svg' width='30px' height='30px' onClick='defaultText()' style='float:right;cursor:pointer;' />";
