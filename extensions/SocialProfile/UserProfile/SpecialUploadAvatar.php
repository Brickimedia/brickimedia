...
class SpecialUploadAvatar extends SpecialUpload {
	...
	protected function getUploadForm( $message = '', $sessionKey = '', $hideIgnoreWarning = false ) {
		...
		// BELOW GEORGE
		# this code redirects Special:UploadAvatar on any wiki besides meta to the meta upload avatar page
		switch ( $_SERVER["HTTP_HOST"] ) {
			case "meta.brickimedia.org":
				break;
			default:
				header( 'Location: http://meta.brickimedia.org/wiki/Special:UploadAvatar' ) ;
				exit(0);
		}
		// ABOVE GEORGE
