...
* SVN  Revision: $Revision: 543 $
* Last Modified: $Date: 2011-05-05 11:05:42 -0400 (Thu, 05 May 2011) $
* 
*/
        ...
        */
        ...
        global $wikieits, $awc_currnt_lang_setting, $awcUser_lang, $tplt, $awc_ver;
                ...
                if(isset($res) AND !empty($res)){
					...
					error_reporting(0); # @since Version 2.5.12
	            	return false;
	            }
...
/**#@-*/ 
        ...
        */
        ...
        static $here_already = null ;
                ...
                $this->rows = 20; # @since Version 2.5.12
